...
namespace AlimentosMarfim.Controllers
{
    public class CargosController : Controller
    {
        ...
        public CargosController(Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeCargo")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeCargo")] Cargo cargo)
        {
            if (id != cargo.Id)
            {
                return NotFound();
